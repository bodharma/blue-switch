...
#ifndef BLUE_SWITCH_SWIFT_H
#define BLUE_SWITCH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Blue_Switch",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11Blue_Switch11AppDelegate")
...
SWIFT_CLASS("_TtC11Blue_Switch16BluetoothManager")
...
@interface BluetoothManager (SWIFT_EXTENSION(Blue_Switch)) <CBCentralManagerDelegate>
- (void)centralManagerDidUpdateState:(CBCentralManager * _Nonnull)central;
@end

/// Manages network service discovery and resolution
SWIFT_CLASS("_TtC11Blue_Switch14ServiceBrowser")
...
@class NSNetService;
@interface ServiceBrowser (SWIFT_EXTENSION(Blue_Switch)) <NSNetServiceBrowserDelegate>
...
@interface ServiceBrowser (SWIFT_EXTENSION(Blue_Switch)) <NSNetServiceDelegate>
...
SWIFT_CLASS("_TtC11Blue_Switch16ServicePublisher")
...
@class NSString;
@class NSNumber;
@interface ServicePublisher (SWIFT_EXTENSION(Blue_Switch)) <NSNetServiceDelegate>
